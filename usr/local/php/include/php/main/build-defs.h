...
#define CONFIGURE_COMMAND " '/home/install_php/src/php-7.2.34/configure'  '--prefix=/usr/local/php' '--enable-fpm' '--with-mcrypt=/usr/local/libmcrypt' '--enable-mbstring' '--enable-pdo' '--with-curl' '--disable-debug' '--disable-rpath' '--enable-inline-optimization' '--with-bz2' '--with-zlib' '--enable-sockets' '--enable-sysvsem' '--enable-sysvshm' '--enable-pcntl' '--enable-mbregex' '--with-mhash' '--with-pcre-regex' '--with-mysql' '--with-mysqli' '--with-gd' '--with-jpeg-dir' '--with-freetype-dir' '--enable-calendar' '--enable-opcache=no'"
...
#define PHP_CONFIG_FILE_PATH    "/usr/local/php/lib"
